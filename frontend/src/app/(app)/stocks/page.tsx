        ...
        <CardContent className="space-y-3">
          <div className="flex flex-wrap gap-2">
            <input
              ...
              className="min-w-[260px] flex-1 rounded-xl border border-[var(--border)] bg-white px-3 py-2 text-sm text-[var(--ink)] outline-none focus:border-[var(--brand)]"
            />
            <button
              onClick={runSearch}
              disabled={searching || !query.trim()}
              className="rounded-xl bg-[var(--brand)] px-3 py-2 text-xs font-semibold text-white transition hover:bg-[var(--brand-strong)] disabled:opacity-50"
            >
